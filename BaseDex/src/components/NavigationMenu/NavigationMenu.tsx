...
export function NavigationMenu() {
    return (
        <nav className={styles.nav_menu}>
            <ul role="menubar">
                <li role="menuitem">
                    <img src={userSolid} alt="user icon for profile" className={styles.nav_img} height='40'/>
                </li>
                <li role="menuitem">
                    <img src={gearSolid} alt="gear icon for settings" className={styles.nav_img} height='40'/>
                </li>
                <li className={styles.home_button} role="menuitem">
                    <img src={houseSolid} alt="house icon for returning to home page" className={styles.nav_img} height='40'/>
                </li>
                <li role="menuitem">
                    <img src={listUlSolid} alt="list icon for pokedex list view" className={styles.nav_img} height='40'/>
                </li>
                <li role="menuitem">
                    <img src={gearSolid} alt="gear icon for settings" className={styles.nav_img} height='40'/>
                </li>
